...
const LevelScript level_sl_entry[] = {
	...
	AREA(1, sl_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_BREAKABLE_BOX,-2833,987,-857,0,337,0,0, bhvHiddenObject, 31),
		OBJECT_WITH_ACTS(MODEL_BREAKABLE_BOX,-2756,987,-1043,0,337,0,0, bhvHiddenObject, 31),
		OBJECT_WITH_ACTS(MODEL_BREAKABLE_BOX,-2572,987,-965,0,337,0,0, bhvHiddenObject, 31),
		OBJECT_WITH_ACTS(MODEL_BREAKABLE_BOX,-2649,987,-779,0,337,0,0, bhvHiddenObject, 31),
